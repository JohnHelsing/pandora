...
>
> https://blog.csdn.net/qq_16268979/article/details/117267918
...
堆外内存和堆内内存是相对的两个概念，其中堆内内存是我们平常工作中接触比较多的，我们在jvm参数中只要使用-Xms，-Xmx等参数就可以设置堆的大小和最大值，理解jvm的堆还需要知道下面这个公式：
...
如下面的图所示：
![img](https://box.kancloud.cn/c93387bee986fcce94f757051aeaf77d_623x309.png)
